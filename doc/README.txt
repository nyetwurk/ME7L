...
ME7Logger: Data Logger for ME7 (c) mki, 11/2010-04/2012 
=======================================================
...
o Also supports FTDI based USB cables (using FTD2XX.DLL).
  USB cables (in dumb mode) work also when using the virtual comport (VCP) driver.
...
o A maximum of 127 freely selectable variables can be logged in parallel.
...
o Was developed under WinXP, but should be able to run under Win95 .. Win7.
...
Usage of ME7Logger:
-------------------
ME7Logger v1.17 (c) mki, 12/2010-03/2012
